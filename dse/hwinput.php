...
<content>
<h1>Input homework</h1>
<form method="POST" id="hw" action="hwprocess.php">
 <textarea id="wmd-input" class="wmd-input processed" name="hwcontent" cols="92" rows="15" tabindex="101" form="hw"> </textarea>
 <br>
