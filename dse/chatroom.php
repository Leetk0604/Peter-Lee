...
<HTML>
  ...
  <li><a href="main.php" >Home Page</a></li>
    ...
    <li><a href="chatroom.php"class="active">Chat room</a></li>
...
<h1>Chatroom</h1>
  <?php
 $myfile = fopen("chatroom.txt", "r") or die("Unable to open file!");
while(!feof($myfile)) {
...
fclose($myfile);
?>
 <form action="chatroomprocess.php" method="POST">
  <input type="text" name="reply" maxlength="100"> </input>
