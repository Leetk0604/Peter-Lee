...
<HTML>
  ...
  <li><a href="main.php" >Home Page</a></li>
    ...
    <li><a href="classphoto.php"class="active">Class Photo</a></li>
...
<content style="background-color:e8e8e8;opacity:0.9;">
<H1>Class Photo</h1>
<?php

$files = glob("classphotocontainer/*.*jpg");
...
for ($i=1; $i<count($files); $i++)
{
	...
	$num = $files[$i];
	echo '
	<img class="classpic" src="'.$num.'" alt="class photo" style="WIDTH:300PX" >'."&nbsp;&nbsp;
	";
