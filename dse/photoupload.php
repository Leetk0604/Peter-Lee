...
<HTML>
   ...
   <ul>
  <li><a href="main.php" class="active">Home Page</a></li>
...
echo "Sorry, there was an unknown error in uploading your file.";
$_Session["uploadOk"] = 0;
} 
else{
$_Session["uploadOk"] = 0; 
}
if($_SESSION["uploadsignal"] == 4) {
	echo "File is not an image.";
	$_Session["uploadsignal"] = 0; 
}
elseif($_SESSION["uploadsignal"] == 1){
	echo "Sorry, file already exists.";
	$_Session["uploadsignal"] = 0; 
}

elseif($_SESSION["uploadsignal"] == 3){
	echo "Sorry, only JPG files are allowed.";
	$_Session["uploadsignal"] = 0; 
}
elseif($_SESSION["uploadsignal"] == 2){
